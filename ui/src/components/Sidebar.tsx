      ...
      `}>
        <div className="flex flex-col h-full p-4">
          <NavLink to="/" className="flex items-center gap-2 mb-8 px-2">
            ...
            <h1 className="text-xl font-bold tracking-tighter">TRIPTYCH NOC</h1>
          </NavLink>
          ...
          <div className="mt-auto p-4 bg-brand-accent/10 rounded-lg border border-brand-accent/30">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[9px] uppercase font-black text-slate-500 tracking-[0.2em]">Sovereign Node</span>
            </div>
