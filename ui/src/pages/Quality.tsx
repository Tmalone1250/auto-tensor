    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between border-b border-brand-accent/30 pb-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-bold tracking-tighter uppercase">Quality Node</h2>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 space-y-6">
          <h3 className="text-xs font-black uppercase text-slate-500 tracking-[0.2em] mb-6">Approval Pipeline</h3>
